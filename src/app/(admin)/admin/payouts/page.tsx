...
import { Loader2, Wallet, Plus, Check } from "lucide-react";
            ...
            <div className="flex items-start justify-between">
              ...
              {p.status === "PENDING" ? (
                <button onClick={() => markPaid(p.id)}
                  className="flex items-center gap-1 text-xs font-semibold text-leaf border border-leaf/30 px-2.5 py-1.5 rounded-lg">
